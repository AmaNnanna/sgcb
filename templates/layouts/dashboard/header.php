...
<doctype html>
    ...
    <head>
        ...
        <meta name="description" content="SGCB GROUP">
        <meta name="author" content="SGCB GROUP">
    ...
    <body>
        ...
        <div class="row no-gutters vh-100 loader-screen">
            <div class="col align-self-center text-white text-center">
                <img src="<?= $assets ?>/dashboard/img/logo.png" alt="IIMCB">
                <h1 class="mt-3">Standard <span class="font-weight-light ">Guarantee Commercial Bank Group</span></h1>
                <p class="text-mute text-uppercase small">Serving Your Needs</p>
