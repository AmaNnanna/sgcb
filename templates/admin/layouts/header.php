...
<body>
  ...
  <div id="main-wrapper">
    ...
    <div class="nav-header">
      <a href="/admin" class="brand-logo h2">SGCB GROUP</a>
            ...
            <ul class="navbar-nav header-right">
              ...
              <?php else : ?>
                <li class="dropdown schedule-event primary">
                  <a href="/admin/accounts" class="btn btn-primary btn-rounded event-btn">
                    <i class="flaticon-381-layer-1"></i>
                    <span class="d-none d-xl-inline-block">Manage </span> <span class="d-none d-lg-inline-block">Accounts</span>
                    <i class="fa fa-caret-right scale3 ml-2 d-none d-sm-inline-block"></i>
                  </a>
                </li>
              <?php endif; ?>
      ...
      <div class="deznav-scroll">
        <ul class="metismenu" id="menu">
          ...
          <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
              ...
              <span class="nav-text">Bank Admin</span>
            </a>
            <ul aria-expanded="false">
              <li><a href="/ibanking/auth/register">Create Account</a></li>
        ...
        <div class="copyright">
          <p>Admin Dashboard <br>© <?php echo date("Y"); ?> All Rights Reserved</p>
          <p class="op5">Made with <span class="heart"></span></p>
        </div>
      </div>
    </div>
