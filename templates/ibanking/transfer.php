    ...
    <div class="wrapper">
        ...
        <div class="container">
            ...
            <?php else : ?>
                        ...
                        <div class="modal-dialog modal-sm modal-dialog-centered mt-0" role="document">
                            <div class="modal-content">
                                <div class="modal-body text-center pt-0">
                                    ...
                                    <button class="btn btn-default btn-rounded-54 shadow"><i class="material-icons">fingerprint</i></button>
                                    <div class="form-group mt-4">
                                        <input type="text" class="form-control form-control-lg text-center" maxlength="12" name="aml_error_code" placeholder="Enter AMLC Code" required="" autofocus="">
                                    </div>
                                </div>
                                <div class="modal-footer border-0">
                ...
                <?php elseif ($Self->data['paystep'] == 9) : ?>
